...
file_title = input('Please enter the name of the file to which you wish to save: ')
with open(f'D:\Programming\{file_title}.txt', 'w') as open_file:
    open_file.write("Just some test text as I didn't do the How To Decode A Website exercise yet")