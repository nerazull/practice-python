...
numbers_array = [value for value in range(101)]

# Solution without binary search
# computer_guess = int(len(numbers_array) // 2)
# tries = 0

# while True:
    
#     player_hint = input(f'Is this your number? {computer_guess}: ')
#     tries += 1

#     if player_hint == 'too low':
#         computer_guess =+ 1
#     elif player_hint == 'too high':
#         computer_guess -= 1
#     elif player_hint == 'correct':
#         print(f'I guessed the number in {tries} tries.')
#         break

# Solution with binary search

low = 0
high = len(numbers_array) - 1
computer_guess = 0
